              ...
              <AnimatePresence mode="popLayout">
                {cartDta.data.products.map((pro) => (
                  <motion.div 
                    ...
                    layout
                    exit={{ opacity: 0, x: shouldReduceMotion ? 0 : -30, transition: { duration: 0.25 } }}
                  ...
                  >
                    <div className="w-full sm:w-32 h-40 sm:h-32 shrink-0 bg-gray-50 dark:bg-gray-800 rounded-xl overflow-hidden relative">
                      <Image 
