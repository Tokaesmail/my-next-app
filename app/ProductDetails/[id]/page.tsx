        ...
        <div className="md:col-span-2 bg-white rounded-2xl shadow-md p-6">
          <CardHeader className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-gray-700 text-sm mt-4">
              <p>
                <strong>Category:</strong> {SingleProduct.category.name}
              </p>
              <p>
              ...
              <p>
                ...
                {new Date(SingleProduct.updatedAt).toLocaleDateString()}
              </p>
              <p>
                <strong>Sold:</strong> {SingleProduct.sold}
              </p>
              <p>
                <strong>Ratings:</strong> {SingleProduct.ratingsQuantity}
              </p>
              <p>
                <strong>Price after discount:</strong>{" "}
                {SingleProduct.priceAfterDiscount || SingleProduct.price} EGP
              </p>
            </div>
